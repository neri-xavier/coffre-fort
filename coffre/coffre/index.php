...
<html>
    ...
    <form action="connected.php" method="post" class="form-inscription">
        ...
        <div class="form-password">
            ...
            <input type="password" id="pass" name="password" minlength="8" pattern="[^\s]+" required>
        </div>
    </br>
    <div class="form-password-confirm">
            <label for="pass">Password (8 characters minimum):</label>
            <input type="password" id="pass-confirm" name="password-confirm" minlength="8" pattern="[^\s]+" required>
        </div>
    </br>
